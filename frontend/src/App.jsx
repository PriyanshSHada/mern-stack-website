...
const ManagerDashboardWithAuth = withRoleProtection(withAuth(ManagerDashboard), ['manager', 'admin']);
const AdminDashboardWithAuth = withRoleProtection(withAuth(AdminDashboard), ['admin']);
